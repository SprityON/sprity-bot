                    ...
                    .then(collected => {
                        ...
                        if (answer.toLowerCase() === 'y' || answer.toLowerCase() === 'yes') {
                            ...
                            .then(collected => {
                                ...
                                query(`INSERT INTO members_rpg (member_id, rpg_name, inventory, basic_stats, armor, gold, level) VALUES ('${msg.member.id}' , '${rpg_name}', '[]', '{"health": 100, "defense": 0, "attack": 20}', '{"armor": "none"}', '100', '1')`)
